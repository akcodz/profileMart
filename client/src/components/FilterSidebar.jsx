...
const FilterSidebar = ({showFilter,setShowFilter,filters, setFilters}) => {
...
navigate('/marketplace')
  ...
  const  onFilterChange = (newFilters)=>{
    ...
    return (
        <div
            className={`${
                showFilter ? "max-sm:fixed" : "max-sm:hidden"
            } inset-0 max-sm:h-screen max-sm:overflow-scroll z-100 bg-white rounded-lg border border-gray-200 h-fit sticky top-24 shadow-sm md:min-w-[300px]`}
        >
...
onFilterChange({...filters, platform:updated.length>0?updated:null});
                                        }}
                ...
                <div>
                    <button
                        ...
                        className="flex items-center justify-between w-full mb-3"
                    >
                        <label className='text-sm font-medium text-gray-800'>Followers</label>
                        <ChevronDown
                            className={`size-4 transition-transform ${
                ...
                <div>
                    ...
                    {expandedSections.niche && (
                        <select
                            ...
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-700 outline-indigo-500">
                            <option value="">Select any niche</option>
                            {niches.map(niche => (
