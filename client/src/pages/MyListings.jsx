...
import {
    ...
    CoinsIcon,
    DollarSign, Edit,
    Eye, EyeIcon, EyeOffIcon, LockIcon,
    Plus,
    StarIcon, TrashIcon,
    TrendingUp, Users,
    WalletIcon, XCircle
      ...
      {listing.price.toLocaleString()}
                                    ...
                                    <div className="flex items-center space-x-2">
                                        {listing.status !== "sold" && (
                                                ...
                                                <button onClick={()=>deletingListing(listing.id)} className="p-2 border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-red-500">
