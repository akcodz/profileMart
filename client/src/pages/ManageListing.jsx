...
const ManageListing = () => {
    ...
    const removeImage =  (indexToRemove) => {
        setFormData((prev) => ({
            ...prev,images:prev.images.filter(x => x !== indexToRemove),
        }))
    }
...
const InputField = ({
    ...
    <div>
        ...
        <input
            ...
            required={required}
            className="w-full px-3 py-1.5 text-gray-600 border border-gray-300 rounded-md
